...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para kaory <3 \n\nSé que esto te tomará por sorpresa y puede parecer muy repentino, pero ya no quería seguírmelo guardando. Preferí arriesgarme y ser sincero contigo antes que quedarme con la duda de qué hubiera pasado.Estos últimos meses que hemos estado hablando han sido muy especiales para mí. De forma muy natural, volver a conectar y compartir contigo me hizo darme cuenta de que tienes exactamente todo lo que siempre he buscado en alguien. Me demostraste que vales totalmente la pena y que por ti me arriesgaría a todo sin pensarlo dos veces.Desde el corazón te digo que me encantaría volver a intentarlo contigo, hacer las cosas bien y darnos la oportunidad de construir algo bonito juntos. No espero una respuesta inmediata, solo necesitaba que supieras lo mucho que significas para mí.\n\n Te quiero más de lo que las palabras pueden expresar  ATT:Omar\n\n.`;  } else {
